        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3  RimsThermometer" style="background-color:Lime">
                        <uc1:BrewThermometer ID="btRims" runat="server" />
                    </div>
                    <div class="col-sm-6 col-lg-3 RimsThermometer" style="background-color:Gray">
                        <uc1:BrewThermometer ID="btMash" runat="server" />
                    </div>
                    <div class="col-sm-6 col-lg-3 RimsThermometer" style="background-color:Lime">
                        <uc1:BrewThermometer ID="btKettle" runat="server" />
                    </div>
                    <div class="col-sm-6 col-lg-3 CountDownTimer" style="background-color:Gray">
                ...
                <%--  <div id="buttonRow">--%>
                <div class="row">
                    <div class="col-sm-6 col-lg-3 switch" id="switchReset">
                    ...
                    <div class="col-sm-6 col-lg-3 switch" id="switchRimsOn">
                    ...
                    <div class="col-sm-6 col-lg-3 switch" id="switchPumpOn">
                    ...
                    <div class="col-sm-6 col-lg-3 switch" id="switchAuxPower">
